    ...
    <div className="table-container">
      ...
      <table className="table">
        <tr className="table-heading">
          <td className="table-heading-data">ID</td>
          <td className="table-heading-data">Title</td>
          <td className="table-heading-data">Description</td>
          <td className="table-heading-data">Price</td>
          <td className="table-heading-data">Category</td>
          <td className="table-heading-data">Sold</td>
          <td className="table-heading-data">Image</td>
        </tr>

        {tableData
          .filter(function (citem, i) {
            return Number(citem.id) <= 10;
          })
          .map(function (citem, i) {
            return <TableRow rowData={citem} key={citem.id} />;
          })}
      </table>
      <TableFooter />
    </div>
